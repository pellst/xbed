These notes are for the EDITORS of xbed
...
Make sure you have an ID range in the [idranges file](xbed-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [xbed-edit.owl](xbed-edit.owl)

** DO NOT EDIT xbed.obo OR xbed.owl in the top level directory **

[../../xbed.owl](../../xbed.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/pellst/xbed) for details.
 ...
 * [xbed-idranges.owl](xbed-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/xbed_terms.txt file
...
Note: the xbed_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as xbed.owl and xbed.obo and places
 ...
 * https://github.com/pellst/xbed/releases
 * https://github.com/pellst/xbed/releases/new
...
what is in the `owl:versionIRI` of the derived xbed.owl (`data-version` in
xbed.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/xbed.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/xbed/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/pellst/xbed.svg?branch=master)](https://travis-ci.org/pellst/xbed)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/pellst](https://travis-ci.org/profile/pellst)
 2. click the "Sync account" button
 3. Click the tick symbol next to xbed
